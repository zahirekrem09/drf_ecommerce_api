...
from user_controller.models import ImageUpload, CustomUser
...
class Business(models.Model):
    user = models.OneToOneField(
        CustomUser, related_name="user_business", on_delete=models.CASCADE)
    name = models.CharField(max_length=100, unique=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class ProductComment(models.Model):
    ...
    user = models.ForeignKey(
        CustomUser, related_name="user_comments", on_delete=models.CASCADE)
...
class Wish(models.Model):
    user = models.OneToOneField(
        CustomUser, related_name="user_wish", on_delete=models.CASCADE)
...
class Cart(models.Model):
    ...
    user = models.ForeignKey(
        CustomUser, related_name="user_carts", on_delete=models.CASCADE)
...
class RequestCart(models.Model):
    user = models.ForeignKey(
        CustomUser, related_name="user_requests", on_delete=models.CASCADE)
    business = models.ForeignKey(
